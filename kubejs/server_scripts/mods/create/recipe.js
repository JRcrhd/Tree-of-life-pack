ServerEvents.recipes((treeoflife) => {
    treeoflife.shaped("createdieselgenerators:burner", ["ABA", " C ", "DED"], {
    ...
    treeoflife.shaped(
        Item.of("custommachinery:custom_machine_item").withNBT({
            machine: "treeoflife:magic_vat",
        }),
        ["ABA", "CDC", "AEA"],
        {
        ...
        results: [
            {
                ...
                nbt: {
                    Mixture: {
                        FluidName: "destroy:glycerol",
                        Contents: [
                            {
                                Molecule: "destroy:glycerol",
                                Concentration: 10.858471,
                            },
                        ],
                    },
                },
...
LootJS.modifiers((treeoflife) => {
    treeoflife
        ...
        .replaceLoot("create:sturdy_sheet", "destroy:nickel_ingot");
    treeoflife
        .addLootTypeModifier(LootType.CHEST)
        .replaceLoot("create:brass_hand", "destroy:lead_ingot");
    treeoflife
        .addLootTypeModifier(LootType.CHEST)
        .replaceLoot("create:brass_ingot", "destroy:lead_ingot");
    treeoflife
        .addLootTypeModifier(LootType.CHEST)
        .replaceLoot("create:brass_nugget", "destroy:nickel_nugget");
});
