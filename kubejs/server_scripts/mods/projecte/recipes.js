ServerEvents.recipes(treeoflife => {
	...
	treeoflife.remove({id: "collector_mk1"});
	treeoflife.remove({id: "collector_mk2"});
	treeoflife.remove({id: "collector_mk3"});
	treeoflife.remove({id: "relay_mk1"});
	treeoflife.remove({id: "relay_mk2"});
	treeoflife.remove({id: "relay_mk3"});
})